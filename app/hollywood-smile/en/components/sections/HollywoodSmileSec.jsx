...
export default function HollywoodSmileSec() {
  return (
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div className="relative z-10  lg:max-w-4xl space-y-6 py-8 lg:pr-24 lg:py-24">
            <h2 className="text-4xl lg:text-5xl font-extralight text-main-900 leading-snug relative z-10">
              A New Standard in Hollywood <br />
            ...
            <p className="text-main-700 leading-relaxed relative z-10">
              At BM TÜRKIEY, we blend art and dental science to create truly
              transformative Hollywood Smile makeovers. With high-grade
              materials, advanced cosmetic techniques, and meticulous smile
              design, we craft radiant, natural-looking results tailored to
              every patient.
            </p>

            <p className="text-main-700 leading-relaxed relative z-10">
              Using premium materials and modern aesthetic methods, we ensure
              your Hollywood Smile is designed to be long-lasting, functional,
              and beautifully unique to you.
            </p>
          ...
          <div className="relative lg:static">
            <div className="relative h-[360px] sm:h-[420px]  lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 lg:h-auto">
              <img
                src="/img/hollywood-smile/smile1.jpg"
                alt="Hollywood Smile"
              ...
              <div className="absolute -top-40 md:top-auto md:bottom-14  right-0 md:right-[24vh] h-28 w-28 md:h-42 md:w-42  rounded-full bg-white/25 backdrop-blur-sm border border-white/35 flex items-center justify-center">
                <img
                  src="/img/hollywood-smile/smile2.jpg"
                  alt="Detail"
