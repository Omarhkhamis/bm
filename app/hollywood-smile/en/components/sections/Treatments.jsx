...
const mediaItems = [
  {
    ...
    provider: "youtube",
    id: "DWjaF4lDca8",
    poster: "https://atomclinic.mezbilisim.dev/reels/DWjaF4lDca8.jpg",
    aspect: "9/16"
  },
  {
    type: "embed",
    provider: "youtube",
    id: "b285Dt47ipQ",
    poster: "https://atomclinic.mezbilisim.dev/reels/b285Dt47ipQ.avif",
    aspect: "9/16"
  },
  {
    type: "embed",
    provider: "youtube",
    id: "Ht_YQEh9Gwo",
    poster: "https://atomclinic.mezbilisim.dev/reels/Ht_YQEh9Gwo.avif",
    aspect: "9/16"
  },
  {
    type: "embed",
    provider: "youtube",
    id: "Ev7R2x0UCZo",
    poster: "https://atomclinic.mezbilisim.dev/reels/Ev7R2x0UCZo.avif",
    aspect: "9/16"
  }
];
        ...
        <div className="grid items-center gap-12 lg:grid-cols-12">
          <div className="lg:col-span-7">
            ...
            <h2 className="mt-3 text-4xl sm:text-4xl lg:text-5xl font-extralight leading-15 text-main-900 tracking-tight">
              Hollywood Smile, <br className="hidden sm:block" />
            ...
            <p className="mt-5 max-w-xl text-[15px] leading-relaxed font-light text-main-600">
              Personalised smile design using premium ceramics and modern
              techniques focused on harmony, comfort, and long-term
              results.
            </p>
            ...
            <div className="mt-10 mb-14 border-l-2 border-copper-400/70 pl-5">
              ...
              <p className="mt-2 text-[14px] font-light text-main-700 leading-relaxed">
                Final suitability is confirmed after clinical assessment.
              </p>

              <a
                href="/hollywood-smile/en/gallery"
                className="mt-4 font-medium inline-flex items-center gap-2 text-[11px] uppercase tracking-[0.24em] text-copper-700 hover:text-copper-800 transition"
              >
                View All Changes <span className="text-copper-500">→</span>
              </a>
            </div>
            ...
            >
              Consult Your Dentist Now →</button>
          </div>
