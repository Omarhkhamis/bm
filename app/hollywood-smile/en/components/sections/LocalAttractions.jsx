const attractions = [
  {
    ...
    minutes: "17",
    distance: "6.2 km",
    image: "/img/attractions/fisekhane.jpg",
    alt: "Fisekhane"
  },
  {
    title: "A Plus AVM",
    ...
    minutes: "12",
    distance: "3.9 km",
    image: "/img/attractions/aplus-avm.jpg",
    alt: "A Plus AVM"
  },
  {
    title: "Metroport AVM",
    ...
    minutes: "5",
    distance: "1.3 km",
    image: "/img/attractions/metroport-avm.jpg",
    alt: "Metroport AVM"
  },
  {
    ...
    minutes: "16",
    distance: "7 km",
    image: "/img/attractions/ataturk-airport.jpg",
    alt: "Atatürk Airport"
  }
];
      ...
      <div className="mx-auto max-w-screen-2xl px-6 lg:px-10">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-3 text-5xl lg:text-5xl font-extralight text-main-900 tracking-tight leading-[1.05]">
            Around the clinic, in a few minutes
          ...
          <p className="mt-4 text-sm sm:text-[15px] font-light text-main-600">
            Shopping and city highlights near BM TÜRKIEY — easy to reach
