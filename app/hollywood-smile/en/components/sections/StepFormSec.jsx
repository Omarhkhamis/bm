...
const toothOptions = [
  {
    key: "aggressive",
    label: "Aggressive",
    image: "https://atomclinic.mezbilisim.dev/img/tooth/aggressive.jpg"
  },
  {
    key: "dominant",
    label: "Dominant",
    image: "https://atomclinic.mezbilisim.dev/img/tooth/dominant.jpg"
  },
  {
    key: "progressive",
    label: "Progressive",
    image: "https://atomclinic.mezbilisim.dev/img/tooth/progressive.jpg"
  },
  {
    key: "focused",
    label: "Focused",
    image: "https://atomclinic.mezbilisim.dev/img/tooth/focused.jpg"
  },
  {
    key: "functional",
    label: "Functional",
    image: "https://atomclinic.mezbilisim.dev/img/tooth/functional.jpg"
  },
  {
    key: "hollywood",
    label: "Hollywood",
    image: "https://atomclinic.mezbilisim.dev/img/tooth/hollywood.jpg"
  },
  {
    key: "tire",
    label: "Tire",
    image: "https://atomclinic.mezbilisim.dev/img/tooth/tire.jpg"
  },
  {
    key: "naturally",
    label: "Naturally",
    image: "https://atomclinic.mezbilisim.dev/img/tooth/naturally.jpg"
  },
  {
    key: "egg-shaped",
    label: "Egg-Shaped",
    image: "https://atomclinic.mezbilisim.dev/img/tooth/egg-shaped.jpg"
  },
  {
    key: "soft",
    label: "Soft",
    image: "https://atomclinic.mezbilisim.dev/img/tooth/soft.jpg"
  }
];

export default function StepFormSec() {
        ...
        <div className="grid p-5 -pt-10 sm:pt-0 sm:p-0 items-center gap-10 lg:grid-cols-12">
          <div className="lg:col-span-5 hidden lg:block">
            <div className="relative overflow-hidden rounded-xl  bg-gradient-to-br from-white via-gray-50 to-gray-100">
              <img
                src="/img/hollywood-smile/step-form-image.jpg"
                alt="Smile"
              ...
              <div className="relative z-10 rounded-2xl bg-white/95 backdrop-blur-xl p-6 sm:p-8 ring-1 ring-black/12 shadow-[0_28px_90px_rgba(0,0,0,0.20),0_1px_0_rgba(255,255,255,0.92)_inset]">
                ...
                <div className="mt-4 md:mt-7">
                  {step === 1 && (
                    <>
                      <p className="text-[15px] font-light text-main-700">
                        Choose your gender to tailor the smile design options.
                      </p>
                  ...
                  {step === 2 && (
                    <>
                      <p className="text-[15px] font-light text-main-700">
                        Choose your dream aesthetic tooth model.
                      </p>
                ...
                <div className="mt-10 flex items-center justify-between gap-4 border-t border-main-200/70 pt-6">
                  <button
                    ...
                    onClick={handlePrev}
                  >
                    <span className="text-copper-600">←</span> Prev
                  </button>
