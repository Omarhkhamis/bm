    ...
    <section className="relative w-full py-14 lg:py-18 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl text-center px-6">
        ...
        <p className="mt-4 mb-8 text-white/80 font-extralight leading-relaxed text-sm sm:text-[15px]">
          We provide a seamless, safe and personalised treatment experience for
          international patients. With expert clinicians, modern technologies
          and dedicated coordinators, BM TÜRKIEY ensures a smooth and
          comfortable journey throughout your stay in Istanbul.
        </p>
