...
<svg viewBox="0 0 1000 1000" class="absolute inset-0" aria-hidden="true">
  ...
  <g id="wheelGroup" style="transform-origin: 500px 500px;">
    <g id="wheelSlices" filter="url(#innerShadow)">
      ...
      <text x="618.63186403318" y="213.5973449215" fill="rgba(255,255,255,0.96)" font-size="30" font-weight="700" text-anchor="middle" dominant-baseline="middle" transform="rotate(-67.5 618.63186403318 213.5973449215)" class=" text-[28px] lg:text-[23px] " style="letter-spacing:0.2px; paint-order:stroke; stroke:rgba(0,0,0,0.18); stroke-width:2px;">20% Discount</text>
      ...
      <text x="786.4026550785" y="381.36813596682" fill="rgba(255,255,255,0.96)" font-size="30" font-weight="700" text-anchor="middle" dominant-baseline="middle" transform="rotate(-22.5 786.4026550785 381.36813596682)" class=" text-[28px] lg:text-[23px] " style="letter-spacing:0.2px; paint-order:stroke; stroke:rgba(0,0,0,0.18); stroke-width:2px;">$75 Discount</text>
      ...
      <text x="786.4026550785" y="618.63186403318" fill="rgba(255,255,255,0.96)" font-size="30" font-weight="700" text-anchor="middle" dominant-baseline="middle" transform="rotate(22.5 786.4026550785 618.63186403318)" class=" text-[28px] lg:text-[23px] " style="letter-spacing:0.2px; paint-order:stroke; stroke:rgba(0,0,0,0.18); stroke-width:2px;">10% Discount</text>
      ...
      <text x="618.63186403318" y="786.4026550785" fill="rgba(255,255,255,0.96)" font-size="30" font-weight="700" text-anchor="middle" dominant-baseline="middle" transform="rotate(67.5 618.63186403318 786.4026550785)" class=" text-[28px] lg:text-[23px] " style="letter-spacing:0.2px; paint-order:stroke; stroke:rgba(0,0,0,0.18); stroke-width:2px;">50% Flight Ticket</text>
      ...
      <text x="381.36813596682" y="786.4026550785" fill="rgba(255,255,255,0.96)" font-size="30" font-weight="700" text-anchor="middle" dominant-baseline="middle" transform="rotate(292.5 381.36813596682 786.4026550785)" class=" text-[28px] lg:text-[23px] " style="letter-spacing:0.2px; paint-order:stroke; stroke:rgba(0,0,0,0.18); stroke-width:2px;">$50 Discount</text>
      ...
      <text x="213.5973449215" y="618.63186403318" fill="rgba(255,255,255,0.96)" font-size="30" font-weight="700" text-anchor="middle" dominant-baseline="middle" transform="rotate(337.5 213.5973449215 618.63186403318)" class=" text-[28px] lg:text-[23px] " style="letter-spacing:0.2px; paint-order:stroke; stroke:rgba(0,0,0,0.18); stroke-width:2px;">$100 Discount</text>
      ...
      <text x="213.5973449215" y="381.36813596682" fill="rgba(255,255,255,0.96)" font-size="30" font-weight="700" text-anchor="middle" dominant-baseline="middle" transform="rotate(382.5 213.5973449215 381.36813596682)" class=" text-[28px] lg:text-[23px] " style="letter-spacing:0.2px; paint-order:stroke; stroke:rgba(0,0,0,0.18); stroke-width:2px;">15% Discount</text>
...
export default function LuckySpinFormSec({ idPrefix } = {}) {
  const reactId = useId();
  ...
  const wheelSvgMarkup = useMemo(() => buildWheelSvg(safeId), [safeId]);
  ...
  const handleSpin = () => {
    ...
    const spins = 5;
    const target =
      rotation + spins * 360 + index * sliceAngle + sliceAngle / 2;
              ...
              <div className="lg:col-span-6 lg:mt-2 md:-mt-5 ">
                <div>
                  ...
                  <p className=" text-[13px] font-light  text-main-500">
                    Try your luck to get a discount coupon.
                  </p>
                  ...
                  <div className="mt-6 grid gap-5">
                    ...
                    <div>
                      ...
                      <input type="hidden" id={`${phoneId}_hidden`} name="phone" />
                    </div>
